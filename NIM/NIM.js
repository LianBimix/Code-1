...
(function (NIM) {
    ...
    function playerTurn() {
        let row = prompt("Choose a row to play from: 1 to 4");
        let fillamount = parseInt(prompt("How many to remove from row " + row + "? (Number must be less than or equal to the number in the row and greater than 0)"));
        switch (row) {
            case "1":
                piles.p1 -= fillamount;
